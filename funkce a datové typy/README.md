Tento program slouží k testování převodu datových typů v PHP. Program projde různé typy vstupů a testuje jejich převod na čtyři očekávané typy: integer, float, string a boolean.
